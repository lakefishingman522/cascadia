...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*cascadiatypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*cascadiatypes.TxResult, error)
...
type Backend struct {
	...
	indexer             cascadiatypes.EVMTxIndexer
}
...
func NewBackend(
	...
	chainID, err := cascadiatypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
