...
import (
	...
	cryptocodec "github.com/cascadiafoundation/cascadia/crypto/codec"
	enccodec "github.com/cascadiafoundation/cascadia/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("cascadia", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, cascadiatypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
	...
	hdPath := cascadiatypes.BIP44HDPath
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, cascadiatypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := hdwallet.MustParseDerivationPath(cascadiatypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Cascadia implementation
	...
	// Equality of Eth and Cascadia implementation
	...
	// Inequality of wrong derivation path of Eth and Cascadia implementation
