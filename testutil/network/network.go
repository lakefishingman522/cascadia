...
func DefaultConfig() Config {
	...
	return Config{
		...
		NumValidators:     4,
		BondDenom:         "aCC",
		MinGasPrices:      fmt.Sprintf("0.000006%s", cascadiatypes.AttoCascadia),
		AccountTokens:     sdk.TokensFromConsensusPower(1000000000000000000, cascadiatypes.PowerReduction),
		StakingTokens:     sdk.TokensFromConsensusPower(500000000000000000, cascadiatypes.PowerReduction),
		BondedTokens:      sdk.TokensFromConsensusPower(100000000000000000, cascadiatypes.PowerReduction),
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	if !cascadiatypes.IsValidChainID(cfg.ChainID) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		clientDir := filepath.Join(network.BaseDir, nodeDirName, "cascadiadcli")
		...
		customAppTemplate, _ := config.AppConfig(cascadiatypes.AttoCascadia)
