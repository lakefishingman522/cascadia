...
// EthSetup initializes a new CascadiaApp. A Nop logger is set in CascadiaApp.
func EthSetup(isCheckTx bool, patchGenesis func(*Cascadia, simapp.GenesisState) simapp.GenesisState) *Cascadia {
