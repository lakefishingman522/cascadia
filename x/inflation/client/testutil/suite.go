...
func (s *IntegrationTestSuite) SetupSuite() {
	...
	var mintData inflationtypes.GenesisState
	s.Require().NoError(s.cfg.Codec.UnmarshalJSON(genesisState[inflationtypes.ModuleName], &mintData))
	...
	genesisState[inflationtypes.ModuleName] = mintDataBz
