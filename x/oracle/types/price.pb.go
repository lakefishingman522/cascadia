...
// source: cascadia/oracle/price.proto
...
func init() {
	proto.RegisterType((*Price)(nil), "cascadia.oracle.Price")
}

func init() { proto.RegisterFile("cascadia/oracle/price.proto", fileDescriptor_0c916a7954166b60) }
