...
var (
	...
	ErrInvalidPricefeederName    = sdkerrors.Register(ModuleName, 1506, "pricefeeder name is nil")
	ErrInvalidPricefeederAddress = sdkerrors.Register(ModuleName, 1507, "invalid pricefeeder address")
)
