...
// source: cascadia/oracle/params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "cascadia.oracle.Params")
}

func init() { proto.RegisterFile("cascadia/oracle/params.proto", fileDescriptor_f7d7a7bc7ab1ff79) }
