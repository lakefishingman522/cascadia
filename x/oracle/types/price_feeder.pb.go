...
// source: cascadia/oracle/price_feeder.proto
...
func init() {
	proto.RegisterType((*PriceFeeder)(nil), "cascadia.oracle.PriceFeeder")
}

func init() { proto.RegisterFile("cascadia/oracle/price_feeder.proto", fileDescriptor_f310b751e06e8fd3) }
