...
import (
	...
	"github.com/cascadiafoundation/cascadia/x/evm/keeper"
...
func (suite *EvmTestSuite) DoSetupTest(t require.TestingT) {
	...
	suite.app = app.EthSetup(checkTx, func(app *app.Cascadia, genesis simapp.GenesisState) simapp.GenesisState {
