...
var _ cascadiatypes.EVMTxIndexer = &KVIndexer{}
...
func (kv *KVIndexer) IndexBlock(block *tmtypes.Block, txResults []*abci.ResponseDeliverTx) error {
	...
	for txIndex, tx := range block.Txs {
		...
		for msgIndex, msg := range tx.GetMsgs() {
			...
			txResult := cascadiatypes.TxResult{
				Height:     height,
...
func (kv *KVIndexer) GetByTxHash(hash common.Hash) (*cascadiatypes.TxResult, error) {
	...
	var txKey cascadiatypes.TxResult
...
func (kv *KVIndexer) GetByBlockAndIndex(blockNumber int64, txIndex int32) (*cascadiatypes.TxResult, error) {
...
func saveTxResult(codec codec.Codec, batch dbm.Batch, txHash common.Hash, txResult *cascadiatypes.TxResult) error {
