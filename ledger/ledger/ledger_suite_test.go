...
import (
	...
	"github.com/cascadiafoundation/cascadia/ledger/ledger/mocks"
...
type LedgerTestSuite struct {
	...
	txAmino    []byte
	txProtobuf []byte
	ledger     ledger.CascadiaSECP256K1
...
func (suite *LedgerTestSuite) SetupTest() {
	...
	suite.ledger = ledger.CascadiaSECP256K1{Hub: hub, PrimaryWallet: mockWallet}
}
