...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "cascadia_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "CASCADIA_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Cascadia_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "cascadia_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "cascadia_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "cascadia_cascadia_9000-1", true, nil,
		},
		{
		...
		{
			"long chain-id", "cascadia_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
