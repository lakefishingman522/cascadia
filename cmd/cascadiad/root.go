...
import (
	...
	cascadiaclient "github.com/cascadiafoundation/cascadia/client"
	"github.com/cascadiafoundation/cascadia/client/debug"
	"github.com/cascadiafoundation/cascadia/encoding"
	"github.com/cascadiafoundation/cascadia/ethereum/eip712"
	cascadiaserver "github.com/cascadiafoundation/cascadia/server"
	servercfg "github.com/cascadiafoundation/cascadia/server/config"
...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd.AddCommand(
		cascadiaclient.ValidateChainID(
	...
	cascadiaserver.AddCommands(
		rootCmd,
		cascadiaserver.NewDefaultStartOptions(a.newApp, app.DefaultNodeHome),
		a.appExport,
		addModuleInitFlags,
	)
	...
	rootCmd.AddCommand(
		...
		queryCommand(),
		txCommand(),
		cascadiaclient.KeyCommands(app.DefaultNodeHome),
	)
